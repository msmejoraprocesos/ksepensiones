    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#F4F6FB' }}>
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: NARANJA, borderRadius: '8px',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '12px', fontWeight: '800', color: 'white', letterSpacing: '-0.5px',
          }}>KSE</div>
          {!collapsed && (
            <div>
            ...
            return (
              <Link key={item.href} href={item.href} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  <span style={{ fontSize: '16px', color: active ? 'white' : 'rgba(255,255,255,0.60)', minWidth: '20px', textAlign: 'center' }}>
                    {item.icon}
                  </span>
                  {!collapsed && (
                    <span style={{ color: active ? 'white' : 'rgba(255,255,255,0.70)', fontSize: '13px', fontWeight: active ? '600' : '400', whiteSpace: 'nowrap' }}>
                      {item.label}
                    </span>
                  )}
                </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.10)', padding: '12px 8px' }}>
          ...
          {!collapsed && userName && (
            <div style={{ padding: '8px 12px', marginBottom: '6px', background: 'rgba(255,255,255,0.06)', borderRadius: '8px' }}>
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div style={{
          ...
          display: 'flex', alignItems: 'center', padding: '0 24px', flexShrink: 0, gap: '12px',
        }}>
          <div style={{ flex: 1 }}>
            <span style={{ color: '#94a3b8', fontSize: '12px' }}>KSE Pensiones</span>
            <span style={{ color: '#94a3b8', fontSize: '12px', margin: '0 6px' }}>/</span>
            <span style={{ color: AZUL, fontSize: '13px', fontWeight: '600' }}>

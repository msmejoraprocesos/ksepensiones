  ...
  async function guardarNuevo() {
    ...
    if (esAsesoria) {
      ...
      if (!form.esquema_pago) {
        ...
        if (!form.monto_pension_mensual || parseFloat(form.monto_pension_mensual) <= 0 || !form.numero_meses_cobro || parseInt(form.numero_meses_cobro) <= 0) {
          newErrors.esquema_pago = 'Define el monto de pensión mensual y el número de meses a cobrar.'
        }

      ...
      {pendientes.length === 0 ? (
        ...
        <div style={{ padding: '0 22px 20px' }}>
          {pendientes.map(a => {
            ...
            return (
              <div key={a.id} style={{ display: 'flex', gap: 14, alignItems: 'flex-start', padding: 'clamp(11.0px, 1.1vw, 14.1px) clamp(10.8px, 1.08vw, 13.9px)', marginBottom: 8, borderRadius: 12, background: vencido ? K.redSoft : K.paper, border: vencido ? `1px solid ${K.red}22` : 'none' }}>

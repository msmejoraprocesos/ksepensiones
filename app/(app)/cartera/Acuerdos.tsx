      ...
      {pendientes.length === 0 ? (
        ...
        <div style={{ padding: '0 22px 20px' }}>
          {pendientes.map(a => {
            ...
            return (
              <div key={a.id} style={{ display: 'flex', gap: 14, alignItems: 'flex-start', padding: 'clamp(11px, 1.25vw, 16px) clamp(11.4px, 1.23vw, 15.8px)', marginBottom: 8, borderRadius: 12, background: vencido ? K.redSoft : K.paper, border: vencido ? `1px solid ${K.red}22` : 'none' }}>

    ...
    <div onClick={onCerrar} style={{ position: 'fixed', inset: 0, background: 'rgba(13,36,64,.55)', zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div onClick={e => e.stopPropagation()} style={{ background: K.card, borderRadius: 16, width: '100%', maxWidth: 'min(520px, 88vw)', maxHeight: '92vh', overflowY: 'auto' }}>
        ...
        <div style={{ padding: '22px 26px' }}>
          <div style={{ background: K.paper, borderRadius: 12, padding: 'clamp(11px, 1.25vw, 16px) clamp(12px, 1.4vw, 18px)', marginBottom: 20 }}>
        ...
        <div style={{ padding: '18px 26px', borderTop: `1px solid ${K.line}`, display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
          <button onClick={onCerrar} aria-label="Cerrar" style={{ padding: '10px 16px', borderRadius: 10, border: `1px solid ${K.line}`, background: 'transparent', color: K.muted, fontSize: 17, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' }}>
            Cancelar
          </button>
